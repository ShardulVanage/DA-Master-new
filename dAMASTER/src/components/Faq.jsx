...
<div class="pb-5 border-b border-gray-300 py-3">
      ...
      <div class="w-full md:w-1/2 p-8 flex justify-end items-end">
        <img class="mx-auto transform  transition ease-in-out duration-1000" src="https://res.cloudinary.com/dtsuvx8dz/image/upload/v1708866970/fxwmyf9wdiswpf8e6kfk.png" alt=""/>
      </div>
    </div>
  </div>
</section>
