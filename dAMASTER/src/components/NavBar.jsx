...
const sections = [
  {
    ...
    title: (
      <>
        <span className="hidden lg:inline">Course curriculum</span>
        <span className="lg:hidden">Course curriculum</span>
      </>
    ),
  },
  { id: 'screencasts', title: 'Features of the course' },
 
  { id: 'pricing', title: 'Pricing' },
  { id: 'author', title: 'Instructor' },
]
